...
SELECT id_entite_ville, entites_ville.position_ville, population_ville.annee AS annee_population, population, nom_ville, ville.annee_debut AS annee_debut_nom, ville.annee_fin AS annee_fin_nom
FROM public.entites_ville
